...
import com.yotsume.managerapp.security.OAuthClientHttpRequestInterceptor;
...
public class ClientBeans {
    ...
    public RestClientProductRestClient productRestClient(
            ...
            @Value("${yotsume.services.catalogue.registration-id:keycloak}") String registrationId) {
